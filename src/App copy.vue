          ...
          <v-layout align-center justify-center>
            ...
            <v-card class="purple lighten-4">
              ...
              <v-card-text>
                  ...
                  <v-slider color="black" track-color="gray" v-model="tax" :thumb-size="16" thumb-label="always"></v-slider>
                </v-row>
                <v-row>
                  <v-subheader class="pl-0">Buy vs Sell Price</v-subheader>
                  <v-slider color="black" track-color="gray" v-model="weight" :thumb-size="16" thumb-label></v-slider>
                  </v-row>
                </v-col>
                <v-col>
...
<v-btn justify-center class="green lighten-3" @click="updateModifiers">Update Modifiers</v-btn>
                </v-row>
